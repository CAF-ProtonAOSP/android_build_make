...
""" % bcb_dev)
  ...
  is_gapps = target_info.GetBuildProp("ro.proton.version").endswith("-gapps")
  androidver = target_info.GetBuildProp("ro.build.version.release")
  protonver = target_info.GetBuildProp("ro.proton.build.version")
  build_id = target_info.GetBuildProp("ro.build.id")
  build_date = target_info.GetBuildProp("ro.proton.build.date")
  securitypatch = target_info.GetBuildProp("ro.build.version.security_patch")
  protondevice = target_info.GetBuildProp("ro.proton.device")

  script.Print("--------------------------------------------")
  script.Print("             Orgasmic Project               ")
  script.Print("--------------------------------------------")
  script.Print("Android Version: %s"%(androidver))
  script.Print("Orgasmic Version: %s"%(protonver))
  script.Print("Build ID: %s"%(build_id))
  script.Print("Build Date: %s"%(build_date))
  script.Print("Security Patch: %s"%(securitypatch))
  script.Print("Device: %s"%(protondevice))
  if is_gapps:
